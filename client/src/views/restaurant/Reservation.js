...
export default function Reservation() {
  ...
  if (reservationDetails && reservationDetails.result_2) {
    ...
    <div>
      ...
      <div className="table-content">
        <div className="table-content-header">
          {!acceptState ? (
            <button className='accept-not-btn' style={{ marginLeft: '75%' }} onClick={() => getReservationDetails()}>New reservation</button>
          ):(
