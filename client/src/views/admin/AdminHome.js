		...
		<br />
			...
			<div className='Row_1'>
				<div className='AdminRow_1Row1'>
					<div style={{width: '35%', fontFamily: 'poppins-bold', fontSize: 35, textAlign: 'center', alignItems: 'center'}}>
					  VGen Dashboard
					</div>
				</div>
				<div className='AdminRow_1Row2'>
					<div style={{marginLeft: '3%', fontFamily: 'poppins-semibold', fontSize: 19, color: 'black', opacity: 0.5}}>
					  {formattedDate}
					</div>
				</div>
				...
				<div className='AdminRow_1Row4'>
					<div style={{width: '25.5%', fontFamily: 'poppins-bold', fontSize: 25, textAlign: 'center', alignItems: 'center'}}>
						<div style={{color: '#242730'}}> Recent Orders</div>
					</div>
					<div style={{display: 'flex', flexDirection: 'row', width: '15%', height: '70%', backgroundColor: '#BCDAC8', borderRadius: 10, marginRight: '3.6%', alignItems: 'center', justifyContent: 'space-around'}}>
