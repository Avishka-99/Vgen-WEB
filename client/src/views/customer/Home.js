...
function Home() {
	...
	const fetchData = async () => {
		try {
			const res = await Axios.get('/api/productGet');
	...
	return (
		<div className='home'>
			...
			<div onClick={() => callBackend()} style={{width: 100, height: 40, outline: '3px solid red', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '4em'}}>
				Click me
			</div>
		</div>
	);
